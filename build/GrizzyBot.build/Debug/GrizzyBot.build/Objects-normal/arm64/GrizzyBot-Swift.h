...
#ifndef GRIZZYBOT_SWIFT_H
#define GRIZZYBOT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GrizzyBot",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC9GrizzyBot11AppDelegate")
...
SWIFT_CLASS("_TtC9GrizzyBot26ComputerNavigationDelegate")
@interface ComputerNavigationDelegate : NSObject <WKNavigationDelegate>
...
@class NSCoder;
SWIFT_CLASS("_TtC9GrizzyBot14PromptTextView")
@interface PromptTextView : NSTextView

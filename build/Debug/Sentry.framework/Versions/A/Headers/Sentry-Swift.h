...
enum SentryDataCategory : NSUInteger;
...
- (BOOL)isRateLimitActive:(enum SentryDataCategory)category SWIFT_WARN_UNUSED_RESULT;
...
/// <code>HTTPURLResponse</code> extension method above, so this thin static wrapper exposes it.
SWIFT_CLASS_NAMED("HTTPHeaderReader")
@interface SentryHTTPHeaderReader : NSObject
/// Reads <code>name</code> from <code>response</code>’s headers case-insensitively. See
/// <code>HTTPURLResponse.value(forHTTPHeaderFieldCaseInsensitive:)</code>.
+ (NSString * _Nullable)valueForHTTPHeaderFieldCaseInsensitive:(NSString * _Nonnull)name inResponse:(NSHTTPURLResponse * _Nonnull)response SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
- (nullable instancetype)initWithDictionary:(NSDictionary<NSString *, id> * _Nonnull)dictionary didFailWithError:(NSError * _Nullable * _Nullable)error;
@end
...
@property (nonatomic, readonly) BOOL isiOSAppOnMac;
@property (nonatomic, readonly) BOOL isMacCatalystApp;
...
@class NSURLRequest;
SWIFT_PROTOCOL_NAMED("RequestManager")
@protocol SentryRequestManager <NSObject>
@property (nonatomic, readonly) BOOL isReady;
- (void)addRequest:(NSURLRequest * _Nonnull)request completionHandler:(SentryRequestOperationFinished _Nullable)completionHandler;
@end
...
SWIFT_PROTOCOL("_TtP6Sentry24SentryCrashReporterState_")
@protocol SentryCrashReporterState <NSObject>
@property (nonatomic, readonly) BOOL installed;
@property (nonatomic, readonly) BOOL crashedLastLaunch;
@end

SWIFT_PROTOCOL("_TtP6Sentry19SentryCrashReporter_")
@protocol SentryCrashReporter <SentryCrashReporterState>
...
typedef SWIFT_ENUM_NAMED(NSUInteger, SentryDataCategory, "SentryDataCategory", open) {
  SentryDataCategoryAll = 0,
  SentryDataCategoryDefault = 1,
  SentryDataCategoryError = 2,
  SentryDataCategorySession = 3,
  SentryDataCategoryTransaction = 4,
  SentryDataCategoryAttachment = 5,
  SentryDataCategoryUserFeedback = 6,
  SentryDataCategoryProfile = 7,
  SentryDataCategoryMetricBucket = 8,
  SentryDataCategoryReplay = 9,
  SentryDataCategoryProfileChunkUI = 10,
  SentryDataCategorySpan = 11,
  SentryDataCategoryFeedback = 12,
  SentryDataCategoryLogItem = 13,
  SentryDataCategoryTraceMetric = 14,
  SentryDataCategoryLogByte = 15,
  SentryDataCategoryTraceMetricByte = 16,
  SentryDataCategoryUnknown = 17,
};

/// Objective-C compatible mapper for <code>SentryDataCategory</code>, replacing the former
/// <code>SentryDataCategoryMapper</code> free functions. Swift callers should prefer the enum’s own
/// <code>name</code>/<code>init(itemType:)</code>/<code>init(name:)</code> API.
SWIFT_CLASS_NAMED("SentryDataCategoryMapper")
@interface SentryDataCategoryMapper : NSObject
+ (NSString * _Nonnull)nameFor:(enum SentryDataCategory)category SWIFT_WARN_UNUSED_RESULT;
+ (enum SentryDataCategory)categoryForEnvelopeItemType:(NSString * _Nonnull)itemType SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
- (nonnull instancetype)initWithEnvironment:(NSString * _Nonnull)environment releaseName:(NSString * _Nullable)releaseName cacheDirectoryPath:(NSString * _Nonnull)cacheDirectoryPath shouldAddDefaultUserId:(BOOL)shouldAddDefaultUserId OBJC_DESIGNATED_INITIALIZER;
- (SentryLog * _Nonnull)applyScope:(SentryScope * _Nonnull)scope toLog:(SentryLog * _Nonnull)log SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic, readonly, strong) id <SentryCrashReporterState> _Nonnull activeCrashReporterState;
...
typedef SWIFT_ENUM_NAMED(NSUInteger, SentryDiscardReason, "SentryDiscardReason", open) {
  SentryDiscardReasonBeforeSend = 0,
  SentryDiscardReasonEventProcessor = 1,
  SentryDiscardReasonSampleRate = 2,
  SentryDiscardReasonNetworkError = 3,
  SentryDiscardReasonQueueOverflow = 4,
  SentryDiscardReasonCacheOverflow = 5,
  SentryDiscardReasonRateLimitBackoff = 6,
  SentryDiscardReasonInsufficientData = 7,
  SentryDiscardReasonSendError = 8,
};
...
SWIFT_CLASS("_TtC6Sentry24SentryEnvelopeItemHeader")
...
@property (nonatomic, readonly, strong) NSNumber * _Nullable itemCount;
...
- (nonnull instancetype)initWithType:(NSString * _Nonnull)type length:(NSUInteger)length OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithType:(NSString * _Nonnull)type length:(NSUInteger)length contentType:(NSString * _Nullable)contentType OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithType:(NSString * _Nonnull)type length:(NSUInteger)length filename:(NSString * _Nullable)filename contentType:(NSString * _Nullable)contentType OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithType:(NSString * _Nonnull)type length:(NSUInteger)length contentType:(NSString * _Nullable)contentType itemCount:(NSNumber * _Nullable)itemCount OBJC_DESIGNATED_INITIALIZER;
- (NSDictionary<NSString *, id> * _Nonnull)serialize SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtC6Sentry30SentryEnvelopeAttachmentHeader")
...
- (nonnull instancetype)initWithType:(NSString * _Nonnull)type length:(NSUInteger)length filename:(NSString * _Nullable)filename contentType:(NSString * _Nullable)contentType attachmentType:(SentryAttachmentType)attachmentType OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithType:(NSString * _Nonnull)type length:(NSUInteger)length OBJC_DESIGNATED_INITIALIZER;
- (NSDictionary<NSString *, id> * _Nonnull)serialize SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithType:(NSString * _Nonnull)type length:(NSUInteger)length contentType:(NSString * _Nullable)contentType SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithType:(NSString * _Nonnull)type length:(NSUInteger)length filename:(NSString * _Nullable)filename contentType:(NSString * _Nullable)contentType SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithType:(NSString * _Nonnull)type length:(NSUInteger)length contentType:(NSString * _Nullable)contentType itemCount:(NSNumber * _Nullable)itemCount SWIFT_UNAVAILABLE;
@end
...
/// Reduces SDK start overhead by swizzling each <code>UIViewController</code> subclass lazily, the first
/// time an instance of it is created, instead of eagerly discovering and swizzling every
/// subclass when the SDK starts.
/// By default, the SDK scans loaded binary images for all <code>UIViewController</code> subclasses at
...
/// realizes <code>@available</code>-gated subclasses that reference newer-framework types, which crashes on
...
/// start-up work and avoids the gated-subclass crash while producing the same <code>ui.load</code>
...
- (void)addWithName:(NSString * _Nonnull)name result:(BOOL)result;
- (void)removeAll;
...
@property (nonatomic, copy) void (^ _Nullable envelopeDeletedCallback)(SentryEnvelopeItem * _Nonnull, enum SentryDataCategory);
...
typedef SWIFT_ENUM_NAMED(NSInteger, SentryFlushResult, "SentryFlushResult", open) {
  SentryFlushResultSuccess = 0,
  SentryFlushResultTimedOut = 1,
  SentryFlushResultAlreadyFlushing = 2,
};
...
/// Objective-C bridge for <code>SentryLog.serializedByteCount()</code>.
SWIFT_CLASS("_TtC6Sentry21SentryLogClientReport")
@interface SentryLogClientReport : NSObject
+ (NSUInteger)serializedByteCountForLog:(SentryLog * _Nonnull)log SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS_NAMED("SentryMeta")
@interface SentryMeta : NSObject
/// The SDK version.
/// <code>Utils/VersionBump</code> rewrites this during releases by matching the declaration below, so keep
/// it on a single line and keep this the first version-shaped literal in the file.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull versionString;)
+ (NSString * _Nonnull)versionString SWIFT_WARN_UNUSED_RESULT;
+ (void)setVersionString:(NSString * _Nonnull)value;
/// The SDK name reported to Sentry, e.g. <code>sentry.cocoa</code>.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull sdkName;)
+ (NSString * _Nonnull)sdkName SWIFT_WARN_UNUSED_RESULT;
+ (void)setSdkName:(NSString * _Nonnull)value;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

/// Objective-C compatible box for the Swift-only <code>SentryMetric</code> struct, so a metric can be passed
/// across the ObjC boundary (e.g. into <code>SentryClientInternal</code>’s client-report drop path) and
/// unwrapped again in Swift. See <code>SentryDataCollectionObjCOptions</code> for the same pattern.
SWIFT_CLASS("_TtC6Sentry16SentryMetricObjC")
@interface SentryMetricObjC : NSObject
/// Serialized byte size for <code>trace_metric_byte</code> client reports. Exposed for the ObjC
/// client-report drop path, which can’t call the Swift-only <code>SentryMetricClientReport</code> directly
/// on a struct.
- (NSUInteger)serializedByteCount SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// important:
/// Request and response parsing happens before publishing the result to internal
...
@interface SentryReplayNetworkDetails (SWIFT_EXTENSION(Sentry))
...
@interface SentrySDK (SWIFT_EXTENSION(Sentry))
...
SWIFT_PROTOCOL_NAMED("Transport")
@protocol SentryTransport <NSObject>
- (void)sendEnvelope:(SentryEnvelope * _Nonnull)envelope;
- (void)storeEnvelope:(SentryEnvelope * _Nonnull)envelope;
- (void)recordLostEvent:(enum SentryDataCategory)category reason:(enum SentryDiscardReason)reason;
- (void)recordLostEvent:(enum SentryDataCategory)category reason:(enum SentryDiscardReason)reason quantity:(NSUInteger)quantity;
- (enum SentryFlushResult)flush:(NSTimeInterval)timeout;
@end

SWIFT_CLASS_NAMED("SentrySpotlightTransport")
@interface SentrySpotlightTransport : NSObject <SentryTransport>
- (nonnull instancetype)initWithOptions:(SentryOptions * _Nonnull)options requestManager:(id <SentryRequestManager> _Nonnull)requestManager requestBuilder:(SentryNSURLRequestBuilder * _Nonnull)requestBuilder OBJC_DESIGNATED_INITIALIZER;
- (void)sendEnvelope:(SentryEnvelope * _Nonnull)envelope;
- (void)storeEnvelope:(SentryEnvelope * _Nonnull)envelope;
- (enum SentryFlushResult)flush:(NSTimeInterval)timeout;
- (void)recordLostEvent:(enum SentryDataCategory)category reason:(enum SentryDiscardReason)reason;
...
SWIFT_CLASS_NAMED("SentryTracerConfiguration")
@interface SentryTracerConfiguration : NSObject
/// Returns an instance with default values.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) SentryTracerConfiguration * _Nonnull defaultConfiguration;)
+ (SentryTracerConfiguration * _Nonnull)defaultConfiguration SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
@property (nonatomic, strong) SentrySamplerDecision * _Nullable profilesSamplerDecision;
...
+ (SentryTracerConfiguration * _Nonnull)configurationWithBlock:(void (^ _Nonnull)(SentryTracerConfiguration * _Nonnull))block SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS_NAMED("SentryTransportAdapter")
@interface SentryTransportAdapter : NSObject
- (nonnull instancetype)initWithTransports:(NSArray<id <SentryTransport>> * _Nonnull)transports options:(SentryOptions * _Nonnull)options OBJC_DESIGNATED_INITIALIZER;
- (void)sendEvent:(SentryEvent * _Nonnull)event session:(SentrySession * _Nonnull)session attachments:(NSArray<SentryAttachment *> * _Nonnull)attachments;
- (void)sendEvent:(SentryEvent * _Nonnull)event traceContext:(SentryTraceContext * _Nullable)traceContext attachments:(NSArray<SentryAttachment *> * _Nonnull)attachments;
- (void)sendEvent:(SentryEvent * _Nonnull)event traceContext:(SentryTraceContext * _Nullable)traceContext attachments:(NSArray<SentryAttachment *> * _Nonnull)attachments additionalEnvelopeItems:(NSArray<SentryEnvelopeItem *> * _Nonnull)additionalEnvelopeItems;
- (void)sendEvent:(SentryEvent * _Nonnull)event withSession:(SentrySession * _Nonnull)session traceContext:(SentryTraceContext * _Nullable)traceContext attachments:(NSArray<SentryAttachment *> * _Nonnull)attachments;
- (void)storeEvent:(SentryEvent * _Nonnull)event traceContext:(SentryTraceContext * _Nullable)traceContext;
- (void)sendEnvelope:(SentryEnvelope * _Nonnull)envelope;
- (void)recordLostEvent:(enum SentryDataCategory)category reason:(enum SentryDiscardReason)reason;
- (void)recordLostEvent:(enum SentryDataCategory)category reason:(enum SentryDiscardReason)reason quantity:(NSUInteger)quantity;
- (void)flush:(NSTimeInterval)timeout;
...
@property (nonatomic, readonly, copy) NSString * _Nullable sanitizedBaseUrl;
